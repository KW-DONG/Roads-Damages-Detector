...
{
    //E:\visual_studio\ConsoleApplication1\YOLO
    string classesFile = "E:/visual_studio/ConsoleApplication1/YOLO/coco_road_1_31.names";//coco.names包含80种不同的类名  need to edit
    ifstream ifs(classesFile.c_str());
    string line;
    while (getline(ifs, line))classes.push_back(line);

    //取得模型的配置和权重文件
    cv::String modelConfiguration = "E:/visual_studio/ConsoleApplication1/YOLO/yolov3-tiny.cfg"; //need to edit
    //cv::String modelWeights = "E:/visual_studio/ConsoleApplication1/YOLO/yolov3-tiny.weights"; //need to edit
    cv::String modelWeights = "E:/visual_studio/ConsoleApplication1/YOLO/yolov3-tiny_road_1_31.weights"; //need to edit
    //加载网络
    ...
    cv::VideoCapture cap("E:/visual_studio/ConsoleApplication1/YOLO/test.mp4");
    cv::VideoWriter video;
    cv::Mat frame, blob;
    //开启摄像头
    //cv::VideoCapture cap(1);
    //创建窗口
    static const string kWinName = "Deep learning object detection in OpenCV"; //原来注释掉
    cv::namedWindow(kWinName,cv::WINDOW_AUTOSIZE);//原来注释掉
